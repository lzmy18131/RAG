...
_DEMO_ROWS: list[tuple[str, int, str, str]] = [
    ...
    ("demo-0003", 2, "text", "故障码 E01：表示激光雷达被遮挡。处理方法：检查并清理激光雷达窗口，重启机器人后若仍报错请联系售后。"),
    ("demo-0004", 2, "table", "故障码对照表：E01=激光雷达遮挡；E02=边刷缠绕；E07=尘盒未安装或安装不到位；PTC=电机过热保护。"),
    ("demo-0005", 3, "text", "故障码 E02：边刷缠绕异物。处理方法：关闭电源，取出边刷并清理缠绕的线缆或毛发后重新安装。"),
    ("demo-0006", 3, "text", "故障码 E07：尘盒未安装。处理方法：确认尘盒已推入到位并听到卡扣声；若尘盒已满请先清空。"),
    ("demo-0007", 4, "text", "PTC 过热保护：长时间高负载运行导致电机过热时，机器人自动停机降温，约 15 分钟后可重新启动。"),
    ("demo-0008", 4, "text", "日常维护：建议每周清理一次主滚刷与边刷，每月更换一次 HEPA 滤网，每季度清洁一次传感器窗口。"),
    ("demo-0009", 5, "text", "参数规格：额定功率 45W，电池容量 5200mAh，续航约 180 分钟，尘盒容量 400ml，水箱容量 350ml。"),
    ("demo-0010", 5, "text", "充电说明：使用随附的 24V 电源适配器为充电座供电；充电时指示灯为橙色，充满后变为绿色。"),
    ("demo-0011", 6, "text", "按键说明：电源键短按开机/关机，长按 3 秒进入配网模式；回充键可随时触发返回充电座。"),
    ("demo-0012", 6, "image", "底部示意图：主滚刷位于中部，两侧为边刷，前部为悬崖传感器，用于检测台阶防止跌落。"),
    ("demo-0013", 7, "text", "防跌落功能：机器人配备悬崖传感器，可检测楼梯等高度差并自动转向，避免从楼梯跌落。"),
    ("demo-0014", 7, "text", "首次使用：安装边刷与尘盒，接通充电座电源，将机器人放上充电座充满电后即可开始清扫。"),
    ("demo-0015", 8, "text", "清扫模式：支持标准、强力、静音三种模式；强力模式吸力最大但续航缩短至约 120 分钟。"),
    ("demo-0016", 8, "text", "水箱组件：安装水箱后进入拖地模式；水箱缺水时机器人暂停拖地并语音提示加水。"),
    ("demo-0017", 9, "text", "清理边刷：将机器人翻转，按下边刷卡扣即可取出；清理后按原方向装回并确认卡紧。"),
    ("demo-0018", 9, "text", "滤网更换：打开尘盒，取出 HEPA 滤网，装入新的滤网并确保密封圈贴合。"),
    ("demo-0019", 10, "text", "Wi-Fi 配网：长按电源键 3 秒进入配网模式，指示灯闪烁；在 App 中选择 2.4GHz 网络并输入密码。"),
    ("demo-0020", 10, "text", "常见问题：机器人找不到充电座时，请确认充电座前方 1.5 米无障碍物，并检查回充信号发射窗清洁。"),
]
